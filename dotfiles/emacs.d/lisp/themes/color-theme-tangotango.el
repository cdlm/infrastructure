...
(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tangotango
     ...
     (mode-line ((t (:foreground "#cccccd" :background "#454743" :box (:line-width 1 :color nil :style released-button)))))
     (mode-line-inactive ((t (:foreground "#bbbbbc" :background "#333"))))
     ...
     (font-lock-comment-face ((t (:foreground "#686a65"))))
     ...
     (font-latex-sedate-face ((t (:foreground "#bb9"))))
     (font-latex-italic-face ((t (:inherit italic :foreground "#ffa"))))
     (font-latex-bold-face ((t (:inherit bold :foreground "#ffa"))))
)))
